      ...
      <main
        ...
        <div
          ...
          <div className="p-3 -mx-3 text-sm text-center bg-gray-100 text-stone-700">
            &quot;Создавайте свои маленькие большие шедевры с бесплатным визуальным конструктором мини-сайтов для смартфона.&quot;
        ...
        <div className="text-stone-400 text-center text-sm mb-10">
